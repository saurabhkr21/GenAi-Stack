        ...
        <div className="min-h-screen grid lg:grid-cols-2">
            ...
            <div className="relative hidden lg:flex flex-col justify-between p-12 bg-[#18181b] overflow-hidden">
                ...
                <div className="absolute inset-0 z-0">
                    <div className="absolute top-0 left-0 w-full h-full bg-[radial-gradient(ellipse_at_top_right,var(--tw-gradient-stops))] from-purple-900/40 via-[#18181b] to-[#18181b]"></div>
                    <div className="absolute -bottom-[20%] -left-[20%] w-[80%] h-[80%] bg-blue-900/20 blur-[150px] rounded-full mix-blend-screen"></div>
                    <div className="absolute top-[20%] right-[10%] w-[40%] h-[40%] bg-purple-900/20 blur-[150px] rounded-full mix-blend-screen"></div>
                </div>
                ...
                <div className="relative z-10">
                    ...
                    className="flex items-center gap-2 text-white font-bold text-xl tracking-tight">
                        <div className="w-8 h-8 bg-linear-to-br from-green-400 to-blue-500 rounded-lg flex items-center justify-center">
                            ai
                        </div>
                        GenAI Stack
                    </button>
                ...
                <div className="relative z-10 space-y-6 max-w-lg">
                    <div className="space-y-2">
                        <h2 className="text-4xl font-bold text-white leading-tight">
                            ...
                            <span className="text-transparent bg-clip-text bg-linear-to-r from-blue-400 to-purple-400">Intelligent Agents</span>
                        </h2>
                        <p className="text-gray-400 text-lg">
                            Join thousands of developers building the future of AI. Create, deploy, and scale your agents in minutes.
                        </p>
                    </div>
                    ...
                    <div className="flex gap-4 pt-4">
                        <div className="flex -space-x-3">
                            {[1, 2, 3, 4].map(i => (
                                <div key={i} className={`w-10 h-10 rounded-full border-2 border-[#18181b] bg-gray-700`} style={{ backgroundImage: `url(https://ui-avatars.com/api/?name=User+${i}&background=random)` }}></div>
                            ))}
                        </div>
                        <div className="flex flex-col justify-center">
                            <span className="text-white font-semibold text-sm">Join 10,000+ others</span>
                ...
                <div className="w-full max-w-[400px] space-y-8">
                    <div className="text-center space-y-2">
                        <div className="lg:hidden flex justify-center mb-6">
                            <div className="w-10 h-10 bg-linear-to-br from-green-400 to-blue-500 rounded-lg flex items-center justify-center font-bold text-white text-xl">
                                ai
                            </div>
                        </div>
